...
set :site_url, %w{observantrecords.dev.forumone.com}
...
set :deploy_to, '/var/www/vhosts/observantrecords.dev'
...
role :app, %w{observantrecords@dev.forumone.com}, :primary => true
role :web, %w{observantrecords@dev.forumone.com}
role :db,  %w{observantrecords@dev.forumone.com}
