...
set :application, 'observantrecords'

# The repo URL
set :repo_url, 'https://github.com/gbueno-f1/observant-records-on-f1-infra'
...
set :linked_dirs, %w[web/wp-content/uploads web/wp-content/upgrade web/wp-content/wflogs]
